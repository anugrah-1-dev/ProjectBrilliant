                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.banks.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="owner" id="owner" class="form-control" placeholder="Nama sesuai rekening"
                                value="{{ old('owner') }}" required>
                        </div>

                        <div class="form-group">
                            <label for="number">Nomor Rekening</label>
                            <input type="text" name="number" id="number" class="form-control" placeholder="Masukkan nomor rekening"
