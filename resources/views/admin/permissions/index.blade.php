        ...
        <div class="modal-dialog">
            <form action="{{ route('admin.permissions.store') }}" method="POST" class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label" for="permission_name">Nama Permission</label>
                        <input type="text" name="name" id="permission_name" class="form-control" placeholder="Masukkan nama permission"
                            required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="permission_guard">Guard</label>
                        <select name="guard_name" id="permission_guard" class="form-select" required>
